...
from src.utils import print_timestamp, copy_fill_settings, dim_cnt_check, time_set_mid, copy_var_names, drop_var_names
...
def tseries_get_vars(varnames, component, experiment, stream=None, freq='mon',
                     cache_dir=cache_dir_default, clobber=None, cluster_in=None):
    """
...
def tseries_get_var(varname, component, experiment, stream=None, freq='mon',
                    cache_dir=cache_dir_default, clobber=None, entries_in=None, cluster_in=None):
    """
