...
_CIME_shr_const_dict = {
    "pi": xr.DataArray(3.14159265358979323846, attrs={"long_name": "pi", "units": "1"}),
    "g": xr.DataArray(
        9.80616,
        attrs={"long_name": "acceleration from Earth's gravity", "units": "m/s2"},
    ),
    "rearth": xr.DataArray(
        6.37122e6, attrs={"long_name": "Earth's radius", "units": "m"}
    ),
    "mwdair": xr.DataArray(
        28.966, attrs={"long_name": "molecular weight of dry air", "units": "g/mol"}
    ),
}
