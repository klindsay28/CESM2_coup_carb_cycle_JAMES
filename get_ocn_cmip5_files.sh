...
for case in b40.prescribed_carb.001 \
   ...
   hsi "cd /CCSM/csm/$case/ocn/proc/tseries/monthly ; ls *.FG_CO2.* *.FvPER_DIC.* *.FvICE_DIC.* *.IRON_FLUX.* *.ATM_CO2.*"
   hsi "cd /CCSM/csm/$case/ocn/proc/tseries/monthly ; cget *.FG_CO2.* *.FvPER_DIC.* *.FvICE_DIC.* *.IRON_FLUX.* *.ATM_CO2.*"
